...
class AboutComprehension(Koan):
    ...
    def test_creating_lists_with_list_comprehensions(self):
        ...
        self.assertEqual('lambs'.capitalize(), comprehension[0])
        self.assertEqual('orangutans'.capitalize(), comprehension[2])
    ...
    def test_unpacking_tuples_in_list_comprehensions(self):
        ...
        self.assertEqual(len('spam'*4), len(comprehension[2]))
